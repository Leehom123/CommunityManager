...
public class MyOpenHelper extends SQLiteOpenHelper {
	...
	public void onOpen(SQLiteDatabase db) {
		...
		db.execSQL("create table if not exists VIEW_MOB_XS_OUT(_id integer primary key autoincrement,mob_no verchar(16),sheet_no verchar(16),sheet_sn int,branch_no verchar(6),cust_no verchar(12),emp_no verchar(4),item_no verchar(8),item_barcode verchar(25),item_price float,item_qty float,item_unit verchar(10),lastdate float,batch_no verchar(20),color verchar(10),size verchar(10),item_name verchar(15),status verchar(1));");
		db.execSQL("create table if not exists VIEW_MOB_CHECK_YP(_id integer primary key autoincrement,mob_no verchar(16),sheet_no verchar(16),sheet_sn int,branch_no verchar(6),item_no verchar(8),item_barcode verchar(25),item_qty float,item_unit verchar(10),status verchar(1));");

		db.execSQL("create table if not exists VIEW_MOB_ORDER(_id integer primary key autoincrement,order_no verchar(16),flag verchar(1) );");
