...
public class GoodDetails extends Activity implements View.OnClickListener{
    private String[] SUP,YWY;
    private Spinner sp_sup ,sp_ywy;
    private ArrayAdapter<String> adapter_sup,adapter_ywy;
    private int sp_item_sup,sp_item_ywy ,sup=0,ywy=0;
...
//                    String num_good = Integer.parseInt(getIntent().getStringExtra("num_good"))+1+"";
                    startActivity(new Intent(GoodDetails.this,RukuDetailsActivity.class).putExtra("sheet_no",sheet_no));
                    finish();
                }else {
